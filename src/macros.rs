...
///
/// ```
/// # #[macro_use] extern crate dimmac; fn main() {
/// # use dimmac::dim;
...
/// # #[macro_use] extern crate dimmac; fn main() {
/// # use dimmac::dims;
/// let index_arr =  dims![x,x, z,z, y,y];
...
/// # Usage
///
/// Any collection that accepts a range of `usize`'s for slicing is compatible with this macro
///
/// ```
/// # #[macro_use] extern crate dimmac; fn main() {
/// # use dimmac::dimr;
